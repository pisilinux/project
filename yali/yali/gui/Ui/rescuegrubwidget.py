...
class Ui_RescueGrubWidget(object):
    def setupUi(self, RescueGrubWidget):
        ...
        RescueGrubWidget.setStyleSheet(_fromUtf8("QListView {\n"
...
"}"))
        ...
        self.deviceList.setFrameShape(QtGui.QFrame.NoFrame)
    ...
    def retranslateUi(self, RescueGrubWidget):
        ...
        self.installSelectedPart.setText(i18n("Disk partition where Pisi Linux is installed"))
