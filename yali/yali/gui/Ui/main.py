...
class Ui_YaliMain(object):
    def setupUi(self, YaliMain):
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 748, 380))
        ...
        self.mainStack.setStyleSheet(_fromUtf8(""))
        ...
        self.buttonBack.setChecked(False)
...
"}"))
        ...
        self.scrollAreaWidgetContents_2.setGeometry(QtCore.QRect(0, 0, 426, 72))
